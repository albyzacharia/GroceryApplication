...
public class ExtenetReport implements ITestListener {
	ExtentSparkReporter sparkReporter;//HTML form of report configuration and log information
	ExtentReports reports;//overall reporting
	ExtentTest test;
	...
	public void configureReport() {
		...
		reports.setSystemInfo("PC Name", "Alby's PC");
		reports.setSystemInfo("OS", "Windows 11");
		reports.setSystemInfo("Test Done By", "Alby Zacharia");		
	...
	public void onFinish(ITestContext context) {
		reports.flush();//to update report
	}
